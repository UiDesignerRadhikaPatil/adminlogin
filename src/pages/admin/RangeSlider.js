...
import "C:/PMS/snp_tax/src/pages/admin/form.css"
    ...
    <>
      ...
      <div className="info">
        ...
        <div className="options">
          ...
          <button
            type="button"
            className="GoogleSerch"
            onClick={() => handleOptionClick("Google Search")}
          >
            Google Search
          </button>
          <button
            type="button"
            className="CapterraGetappG2"
            onClick={() => handleOptionClick("Capterra/Getapp/G2")}
          >
            Capterra/Getapp/G2
          </button>
          <button
            ...
            onClick={() => handleOptionClick("From friend")}
          >
            From friend
          </button>
          <button
            ...
            onClick={() => handleOptionClick("Offline event")}
          >
            Offline event
          </button>
          <button
        ...
        <div className="othersoptions">
          <button
            type="button"
            className="TaxDomeConsutanrtPartner"
            onClick={() =>
              handleOptionClick("PMS Solutions Consutanrt/Partner")
            }
          >
